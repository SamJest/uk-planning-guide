(function () {
  ...
  function renderNewProjectForm() {
    ...
    root.innerHTML = "<div class='app-status' data-app-status aria-live='polite'></div>" +
      ...
      "<div class='form-field'><label for='hp-property'>Property label <span class='visually-hidden'>(optional)</span></label><input id='hp-property' name='propertyLabel' maxlength='160' placeholder='Use a private label, not necessarily the full address'><small>Stored only in this browser in the first release.</small></div>" +
