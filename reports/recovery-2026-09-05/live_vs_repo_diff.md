...
## Custom 404 follow-up

The add-only `artifacts/releases/recovery-404-2` candidate was merged through PR16 as `9e9db28956159587c57d88c7efebe22843f635ed`. A cache-bypassed random missing path now returns HTTP 404 with `data-not-found-page`, `noindex, follow`, no canonical and no meta refresh. Its served LF-normalised SHA-256 (`b3f4009289667f7cef7c4821b8dde70f4b3537819c7f7bf4e4222ed92492887d`) exactly matches the reviewed release after Git checkout normalisation. Submitted sitemap membership remains 35,208 unique URLs.
