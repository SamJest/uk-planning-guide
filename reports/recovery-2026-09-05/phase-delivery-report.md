...
Status at 6 September 2026: source phases committed; production unchanged; release candidate not deployed.
...
- Final source fingerprint: `a55c7959bc617c9c43656b107c0d295e5a86b5f503f3773fbac2b7ed389e19ab`.
- Clean scoped canary: `artifacts/builds/recovery-semantic-5`; 24 publish routes; 11 generators; 13.66 seconds; zero Phase0 errors/warnings.
...
Production is still Git commit `aa7d89ec029c70d5973b7d982fcbe5036316d9b2`, tree `9c640ff1b40473f2e025e9368ac008d41b1e5cc5`. No remote branch, pull request, Pages commit or live file has yet been changed. Before deployment, create an exact generated branch from the then-current production commit, apply only the eight manifest files, validate the overlay, run browser/performance checks, and use a normal revert commit as rollback.
